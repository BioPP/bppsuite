...
int main(int args, char** argv)
{
  ...
  try
  {
    ...
    if (listPath == "none")
      throw Exception("You must provide an input tree list file.");
    ...
    if (outgroupsPath == "none")
      throw Exception("You must provide an outgroup list file.");
    ...
    if (outputPath == "none")
      throw Exception("You must provide an output file.");
